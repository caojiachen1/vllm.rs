...
use crate::{
    ...
    models::glm_ocr::GlmOcrForConditionalGeneration,
...
pub enum Model {
    ...
    GlmOcr(Arc<GlmOcrForConditionalGeneration>),
...
impl ModelRunner {
    ...
    pub fn new(
        ...
        let model = crate::build_model!(
            ...
            reporter,
            {
                ...
                GlmOcr => GlmOcrForConditionalGeneration,
    ...
    pub fn get_model_vocab_size(&self) -> usize {
        match &self.model {
            ...
            Model::GlmOcr(model) => model.get_vocab_size(),
